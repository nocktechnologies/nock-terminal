...
- Fixed the Anvil Codex security-review workflow invocation and added an OpenAI auth preflight so missing, malformed, or unauthorized `OPENAI_API_KEY` configuration skips cleanly instead of posting CLI/auth traces.
