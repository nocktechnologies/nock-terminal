...
H4a implements this as a reducer with tests before wiring it into polling. Future H4 work should reuse the reducer instead of adding a second status parser in the main process or dashboard.
