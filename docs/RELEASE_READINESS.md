...
- Managed local residents reject altered Claude/Python executable paths, require a complete non-secret Claude auth identity before becoming startable, and can open their residence in a terminal without granting it general project/file trust.
